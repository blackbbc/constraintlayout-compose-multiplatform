 ...
 * [androidx.constraintlayout.core.shaded.state.Transition].
 */
...
internal class TransitionHandler(
    ...
    private val transition: androidx.constraintlayout.core.shaded.state.Transition
        get() = motionMeasurer.transition

    /**
     * Whether we consume the rest of the drag for OnSwipe.
     *
     * @see androidx.constraintlayout.core.shaded.state.Transition.isFirstDownAccepted
     */
