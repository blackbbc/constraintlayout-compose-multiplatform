...
@LayoutScopeMarker
@Stable
class HorizontalChainScope internal constructor(internal val id: Any, containerObject: CLObject) {
    /**
...
@LayoutScopeMarker
@Stable
class VerticalChainScope internal constructor(internal val id: Any, containerObject: CLObject) {
    /**
     * Reference to the [ConstraintLayout] itself, which can be used to specify constraints between
     * itself and its children.
     */
...
private class ChainVerticalAnchorable constructor(containerObject: CLObject, index: Int) :
    BaseVerticalAnchorable(containerObject, index)

private class ChainHorizontalAnchorable constructor(containerObject: CLObject, index: Int) :
