...
// import androidx.constraintlayout.core.shaded.motion.MotionPaths
...
//        mPaintGraph.color = Color(mGraphColor)
...
//        }
//        canvas.translate(mShadowTranslate.toFloat(), mShadowTranslate.toFloat())
//        mPaint.color = Color(mShadowColor)
//        mFillPaint.color = Color(mShadowColor)
//        mPaintKeyframes.color = Color(mShadowColor)
//        mPaintGraph.color = Color(mShadowColor)
//        motionController.buildPath(mPoints, frames)
//        if (drawPath) {
//            drawBasicPath(canvas)
//        }
...
//        path.moveTo(x, y)
//        path.lineTo(xp, yp)
//        val len = hypot((xp - x).toDouble(), (yp - y).toDouble()).toFloat()
...
//            mPath!!.close()
//        }
//        mPaint.color = Color(0x44000000)
//        canvas.translate(2f, 2f)
//        canvas.drawPath(mPath!!, mPaint)
//        canvas.translate(-2f, -2f)
//        mPaint.color = Color(-0x10000)
//        canvas.drawPath(mPath!!, mPaint)
//    }
//
//    companion object {
