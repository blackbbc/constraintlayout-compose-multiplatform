...
import androidx.constraintlayout.core.shaded.motion.MotionWidget.Companion.UNSET
import androidx.constraintlayout.core.shaded.motion.key.MotionConstraintSet
import androidx.constraintlayout.core.shaded.motion.key.MotionKey
import androidx.constraintlayout.core.shaded.motion.key.MotionKeyAttributes
import androidx.constraintlayout.core.shaded.motion.key.MotionKeyCycle
import androidx.constraintlayout.core.shaded.motion.key.MotionKeyPosition
import androidx.constraintlayout.core.shaded.motion.key.MotionKeyTimeCycle
import androidx.constraintlayout.core.shaded.motion.key.MotionKeyTrigger
import androidx.constraintlayout.core.shaded.motion.utils.CurveFit
import androidx.constraintlayout.core.shaded.motion.utils.DifferentialInterpolator
import androidx.constraintlayout.core.shaded.motion.utils.Easing
import androidx.constraintlayout.core.shaded.motion.utils.FloatRect
import androidx.constraintlayout.core.shaded.motion.utils.KeyCache
import androidx.constraintlayout.core.shaded.motion.utils.KeyCycleOscillator
import androidx.constraintlayout.core.shaded.motion.utils.KeyCycleOscillator.PathRotateSet
import androidx.constraintlayout.core.shaded.motion.utils.KeyFrameArray.CustomVar
import androidx.constraintlayout.core.shaded.motion.utils.Rect
import androidx.constraintlayout.core.shaded.motion.utils.SplineSet
import androidx.constraintlayout.core.shaded.motion.utils.TimeCycleSplineSet
import androidx.constraintlayout.core.shaded.motion.utils.TypedValues
import androidx.constraintlayout.core.shaded.motion.utils.TypedValues.MotionType
import androidx.constraintlayout.core.shaded.motion.utils.TypedValues.TransitionType
import androidx.constraintlayout.core.shaded.motion.utils.Utils
import androidx.constraintlayout.core.shaded.motion.utils.VelocityMatrix
import androidx.constraintlayout.core.shaded.motion.utils.ViewState
...
//            }
    ...
    fun positionKeyframe(
        ...
        val start = androidx.constraintlayout.core.shaded.motion.utils.FloatRect()
        start.left = mStartMotionPath.mX
        start.top = mStartMotionPath.mY
        start.right = start.left + mStartMotionPath.mWidth
        start.bottom = start.top + mStartMotionPath.mHeight
        val end = androidx.constraintlayout.core.shaded.motion.utils.FloatRect()
        end.left = mEndMotionPath.mX
        end.top = mEndMotionPath.mY
        end.right = end.left + mEndMotionPath.mWidth
        end.bottom = end.top + mEndMotionPath.mHeight
