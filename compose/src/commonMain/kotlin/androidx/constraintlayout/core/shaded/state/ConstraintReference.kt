 ...
 */
package androidx.constraintlayout.core.shaded.state

import androidx.constraintlayout.core.shaded.motion.utils.TypedBundle
import androidx.constraintlayout.core.shaded.motion.utils.TypedValues
import androidx.constraintlayout.core.shaded.state.State.Constraint.BASELINE_TO_BASELINE
import androidx.constraintlayout.core.shaded.state.State.Constraint.BASELINE_TO_BOTTOM
import androidx.constraintlayout.core.shaded.state.State.Constraint.BASELINE_TO_TOP
import androidx.constraintlayout.core.shaded.state.State.Constraint.BOTTOM_TO_BASELINE
import androidx.constraintlayout.core.shaded.state.State.Constraint.BOTTOM_TO_BOTTOM
import androidx.constraintlayout.core.shaded.state.State.Constraint.BOTTOM_TO_TOP
import androidx.constraintlayout.core.shaded.state.State.Constraint.CIRCULAR_CONSTRAINT
import androidx.constraintlayout.core.shaded.state.State.Constraint.END_TO_END
import androidx.constraintlayout.core.shaded.state.State.Constraint.END_TO_START
import androidx.constraintlayout.core.shaded.state.State.Constraint.LEFT_TO_LEFT
import androidx.constraintlayout.core.shaded.state.State.Constraint.LEFT_TO_RIGHT
import androidx.constraintlayout.core.shaded.state.State.Constraint.RIGHT_TO_LEFT
import androidx.constraintlayout.core.shaded.state.State.Constraint.RIGHT_TO_RIGHT
import androidx.constraintlayout.core.shaded.state.State.Constraint.START_TO_END
import androidx.constraintlayout.core.shaded.state.State.Constraint.START_TO_START
import androidx.constraintlayout.core.shaded.state.State.Constraint.TOP_TO_BASELINE
import androidx.constraintlayout.core.shaded.state.State.Constraint.TOP_TO_BOTTOM
import androidx.constraintlayout.core.shaded.state.State.Constraint.TOP_TO_TOP
import androidx.constraintlayout.core.shaded.state.helpers.Facade
...
import androidx.constraintlayout.core.shaded.widgets.ConstraintWidget.Companion.HORIZONTAL
import androidx.constraintlayout.core.shaded.widgets.ConstraintWidget.Companion.UNKNOWN
import androidx.constraintlayout.core.shaded.widgets.ConstraintWidget.Companion.VERTICAL
