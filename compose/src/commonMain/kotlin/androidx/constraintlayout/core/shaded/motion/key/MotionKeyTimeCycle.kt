 ...
 */
package androidx.constraintlayout.core.shaded.motion.key
...
import androidx.constraintlayout.core.shaded.motion.utils.TimeCycleSplineSet.CustomVarSet
import androidx.constraintlayout.core.shaded.motion.utils.TypedValues
import androidx.constraintlayout.core.shaded.motion.utils.TypedValues.AttributesType
import androidx.constraintlayout.core.shaded.motion.utils.TypedValues.CycleType
    ...
    fun addTimeValues(splines: HashMap<String, TimeCycleSplineSet>) {
        for (s in splines.keys) {
            ...
            if (s.startsWith(CUSTOM)) {
                val cKey = s.substring(CUSTOM.length + 1)
